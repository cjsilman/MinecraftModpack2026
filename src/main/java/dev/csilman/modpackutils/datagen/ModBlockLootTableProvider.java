...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.CHESED_BEACON_BLOCK.get());
        dropSelf(ModBlocks.MALKUTH_BEACON_BLOCK.get());
        dropSelf(ModBlocks.ABYSS_BEACON_PEDESTAL_BLOCK.get());
        dropSelf(ModBlocks.CURSED_BEACON_PEDESTAL_BLOCK.get());
        dropSelf(ModBlocks.DESERT_BEACON_PEDESTAL_BLOCK.get());
